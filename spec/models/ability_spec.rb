require 'rails_helper'
 ...
 describe Ability do
   ...
   describe 'for user' do
     ...
     it { should be_able_to :destroy, create(:attachment, attachmentable: question)}
     it { should_not be_able_to :destroy, create(:attachment, attachmentable: other_question)}
     it { should be_able_to :destroy, Vote, user: user }
     it { should_not be_able_to :destroy, create(:vote, votable: other_question, user: other)}
   end
 end
